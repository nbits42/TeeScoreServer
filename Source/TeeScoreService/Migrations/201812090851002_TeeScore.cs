namespace TeeScoreService.Migrations
{
    ...
    public partial class TeeScore : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.Tees", t => t.HoleId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Scores", "HoleId", "dbo.Tees");
            DropForeignKey("dbo.Tees", "GameId", "dbo.Games");
            DropForeignKey("dbo.Scores", "GameId", "dbo.Games");
            DropIndex("dbo.Tees", new[] { "CreatedAt" });
            DropIndex("dbo.Tees", new[] { "GameId" });
            DropIndex("dbo.Scores", new[] { "CreatedAt" });
